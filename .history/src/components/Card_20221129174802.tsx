  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="flex flex-col bg-gray-500 rounded-md fixed top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 w-[85vw]">
          <Dialog.Title className="">Teste</Dialog.Title>
          <Dialog.Description />
          <Dialog.Close />
        </Dialog.Content>
      </Dialog.Portal>
