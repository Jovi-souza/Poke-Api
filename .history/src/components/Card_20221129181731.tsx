  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="flex flex-col justify-center items-center bg-gray-500 rounded-md px-4 py-6 fixed top-[50%] left-[50%] -translate-y-[50%] -translate-x-[50%] w-[70%] max-w-xs">
