  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="flex flex-col justify-center items-center bg-gray-500 rounded-md fixed top-[50%] left-[50%] -translate-y-[50%] -translate-x-[50%] w-[70%] max-w-">
